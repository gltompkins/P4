...
Route::get('/sitelists', 'SitelistController@getIndex');

Route::get('/sitelists/show', 'SitelistController@getIndex');

Route::get('/sitelists/create', function () {
    return 'form for creating a new websites listing';
});

Route::post('/sitelists/create', function () {
